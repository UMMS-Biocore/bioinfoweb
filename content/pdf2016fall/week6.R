...
source("http://bioinfo.umassmed.edu/content/pub/funcs.R")
...
#To read the file from your disk
#file <- "/project/umw_biocore/class/data.tsv"

#To read the file from url
url <- "http://bioinfo.umassmed.edu/content/pub/data.tsv"
